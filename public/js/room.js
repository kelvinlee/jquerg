...
var connect_socket, createEditor, createEditor_default, editor, editorList, path, popshow, read, socket;
...
connect_socket = function(url) {
  ...
  return socket.on('editor', function(data) {
    read = false;
...
$(function() {
  ...
  $('.typcn-arrow-minimise').on('click', function() {
    var Mname;
    Mname = $(this).attr('for');
